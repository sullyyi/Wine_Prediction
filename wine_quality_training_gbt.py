...
def main(train_path, val_path, output_path):
    ...
    #load datasets (semicolon-delimited, strip quotes)
    train_df = (spark.read
                .option("header", True)
    ...
    #train a small Gradient-Boosted Trees model
    gbt = GBTClassifier(
    ...
    print(f"Validation GBT F1 score = {f1:.4f}")

    spark.stop()

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train and save a GBT wine quality model")
